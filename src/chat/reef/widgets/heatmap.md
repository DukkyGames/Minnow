...
.rw-cell[data-l="1"] { background: var(--accent); opacity: 0.28; }
.rw-cell[data-l="2"] { background: var(--accent); opacity: 0.48; }
.rw-cell[data-l="3"] { background: var(--accent); opacity: 0.72; }
.rw-cell[data-l="4"] { background: var(--accent); opacity: 1; border-color: var(--accent-dim); }
