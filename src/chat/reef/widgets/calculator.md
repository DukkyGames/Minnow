...
.rw label { display: flex; flex-direction: column; gap: 4px; font-size: 0.8125rem; font-weight: 400; color: var(--text-muted); }
.rw input {
...
.rw-out {
  ...
  background: var(--surface-elevated); font-family: var(--font-mono); font-size: 0.875rem;
}
