...
- Minnow is a local-first AI workspace: chats, **100+ built-in tools** (106 in a default build; MCP servers add more), and eight core apps — **Chat**, **Code**, **Research**, **Models**, **Brain**, **Issues**, **Scheduler**, and **Settings**.
