...
---
<!-- Upstream: https://github.com/mattpocock/skills @ skills/engineering/ask-matt/SKILL.md (MIT) -->
...
**`/setup-minnow-skills`** — run before your first engineering flow to configure the issue tracker, triage labels, and doc layout the other skills assume. Custom issue trackers also work.
