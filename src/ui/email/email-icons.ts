...
export const EMAIL_ICONS = {
  ...
  snooze: `${SVG_OPEN}${paths(["M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20z", "M12 6v6l4 2"])}${SVG_CLOSE}`,
  move: `${SVG_OPEN}${paths(["M5 9l-3 3 3 3", "M9 12h12", "M19 15l3-3-3-3", "M15 12H3"])}${SVG_CLOSE}`,
  help: `${SVG_OPEN}${paths(["M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20z", "M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3", "M12 17h.01"])}${SVG_CLOSE}`,
  ...
  close: `${SVG_OPEN}${paths(["M18 6L6 18", "M6 6l12 12"])}${SVG_CLOSE}`,
} as const;
