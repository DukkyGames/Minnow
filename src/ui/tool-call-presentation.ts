...
const TOOL_ICON: Record<string, IconName> = {
  ...
  delegate_tasks: 'boardGroup',
  board_init: 'boardView',
  board_update_task: 'boardBuild',
  board_set_autonomy: 'automations',
  board_get_state: 'boardView',
  board_report: 'dashboard',
  issue_add: 'appIssues',
...
const TOOL_ACTION: Record<string, string> = {
  ...
  board_init: 'New board',
  board_update_task: 'Update task',
  board_set_autonomy: 'Set autonomy',
  board_get_state: 'Read board',
  board_report: 'Report',
