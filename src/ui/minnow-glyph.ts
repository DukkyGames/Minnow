...
export const MINNOW_GLYPH_EMPTY_HTML = `<svg class="minnow-glyph icon-svg" viewBox="0 0 100 100" aria-hidden="true"><path fill="currentColor" d="${BODY}"/><path fill="currentColor" d="${TAIL}"/></svg>`;
