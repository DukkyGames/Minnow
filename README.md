...
- **Skills** — drop a `SKILL.md` into `~/.minnow/skills/` and call it with `/` in the composer. Seventeen ship built in; install more from the Skills Library, or write your own.
