...
describe('tool payload token reduction', () => {
  // Ceiling moved 9,850 → 10,000 when `open_in_editor` joined files-read (+122 tok).
  // It is a guardrail against unnoticed growth, not a hard budget: raise it only
  // alongside a tool the product actually needs, and keep the schema terse.
