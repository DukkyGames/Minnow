...
Systematic keyboard operability, focus management, screen-reader behavior, and contrast coverage for Minnow apps. Regression guard: `npm run test:a11y` (includes `test/theme-contrast.test.mts`).
