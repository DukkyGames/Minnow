...
**Calendar app (MIN-129, shipped):** MinnowOS **Calendar** app (`#/app/calendar`) — local-first SQLite store at `~/.minnow/calendar/calendar.db` ([`server/calendar/store.js`](../server/calendar/store.js)), month/week grid UI ([`src/ui/calendar-page.ts`](../src/ui/calendar-page.ts), [`src/ui/calendar/calendar-panel.ts`](../src/ui/calendar/calendar-panel.ts) — sidebar **CalDAV** section to add/remove accounts and per-account sync), `.ics` import/export ([`server/calendar/ics.js`](../server/calendar/ics.js)), RRULE expansion ([`server/calendar/recurrence.js`](../server/calendar/recurrence.js)), encrypted CalDAV accounts (#12 secret-box at `~/.minnow/calendar/secrets/`), bidirectional sync via `tsdav` ([`server/calendar/caldav.js`](../server/calendar/caldav.js)), SSRF validation ([`server/calendar/caldav-ssrf.js`](../server/calendar/caldav-ssrf.js)), REST `/api/calendar/*` ([`server/calendar/middleware.js`](../server/calendar/middleware.js)), agent tool `manage_calendar` ([`server/calendar/tool-handler.js`](../server/calendar/tool-handler.js)), and upcoming-event reminders that enqueue into the scheduler notification queue ([`server/calendar/reminders.js`](../server/calendar/reminders.js) → `GET /api/calendar/upcoming`). Client API: [`src/calendar/client.ts`](../src/calendar/client.ts). Styles: [`src/styles/calendar.css`](../src/styles/calendar.css). Plan: [`documentation/plans/Odysseus port/odysseus-port-10-calendar.md`](plans/Odysseus%20port/odysseus-port-10-calendar.md). Tests: `npm run test:calendar`.
