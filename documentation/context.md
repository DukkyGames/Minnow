...
|-------|---------|----------|
| Desktop | `#osDesktopLayer` | Wallpaper, hero greeting, desktop chat rail + transcript, composer dock, research card overlay |
| Windows | `#osWindowsLayer` | Floating `WindowFrame` instances (Settings, Models, Bench, Compare, Experts, Calendar; scheduler job editor; calendar event editor) |
...
**Tests:** `test/os/window-manager.test.mts`, `window-apps.test.mts`, `desktop-chat-state.test.mts`, `desktop-research-state.test.mts`, `scheduler-app.test.mts`, `calendar-app.test.mts`, `router.test.mts`.
