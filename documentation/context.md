...
| `GET` | `/api/tts/status` | TTS backend health |
...
Tests: `test/voice/*.test.mjs`, `test/stt/*.test.mjs`, `test/tts/synthesize.test.mjs`, `test/ui/voice-controls.test.mts`, `test/os/models-app.test.mts`.
