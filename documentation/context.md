...
| Experts hub (MIN-59) | `#/experts`, topbar `#btnExpertLab` → `openExpertLabFromTopbar()` alias of `openExperts()`; `src/ui/experts/experts-hub.ts`, `src/styles/experts-hub.css`, `src/styles/experts-summon.css` |
