...
| **Settings** | `#/app/settings` | Full config via `/api/config/*`; General category includes General, Notifications, Audio, About; Appearance uses the same emphasis-panel layout; Advanced includes Health & diagnostics |
