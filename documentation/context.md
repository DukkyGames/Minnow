...
| `POST /api/memory/embeddings/reindex` | Rebuild `vectors.json` for all entries |
...
| `brain_search` | Workspace-scoped hybrid wiki search via [`server/tools/brain-tools.js`](../server/tools/brain-tools.js) |
| `brain_read_page` | Read one wiki page by relative path |
...
| `brain_search` | Workspace-scoped hybrid wiki search |
| `brain_read_page` | Read wiki page by path |
